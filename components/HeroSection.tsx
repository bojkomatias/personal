...
export const HeroSection = () => {
  return (
    <main className="md:relative">
      <div className="mx-auto w-full max-w-7xl pt-16 pb-20 text-center md:py-48 md:text-left">
        <div className="px-4 sm:px-8 md:w-1/2 xl:pr-16">
          <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl md:text-5xl xl:text-6xl">
      ...
      <div className="relative h-64 w-full sm:h-72 md:absolute md:inset-y-0 md:right-0 md:h-96 md:h-full md:w-1/2">
        <img
